...
public class AnnyengApiController implements AnnyengApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(AnnyengApiController.class);
    ...
    public AnnyengApiController(ObjectMapper objectMapper, HttpServletRequest request) {
